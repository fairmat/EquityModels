...
namespace HistoricalSimulator
{
    ...
    public class HistoricalSimulatorSymbolChoice : IEditableChoice
    {
        ...
        {
            get { return "Historical Simulator"; }
        }
        ...
        {
            return new StochasticProcessExtendible(null, new HistoricalSimulator());
        }
